...
import anthropic_research_publications from './lib/anthropic/research/publications';
...
let plugins = [anthropic_research_publications, bilibili_user_dynamic, bilibili_user_video, telegram_channel, weibo_user, xiaohongshu_user];
